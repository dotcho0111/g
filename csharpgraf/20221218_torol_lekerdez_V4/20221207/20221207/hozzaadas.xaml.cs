...
namespace _20221207
{
    ...
    public partial class hozzaadas : Window
    {
        ...
        {
            if (int.TryParse(txt_irsz.Text, out int irsz) && txt_nev.Text != "" && txt_cim.Text != "" && txt_irsz.Text.Length == 4 && txt_irsz.Text[0] != '0')
            {
                ...
                string query = "SELECT * FROM konyvtarak WHERE konyvtarNev='" + txt_nev.Text + "' " + "and cim='" + txt_cim.Text + "' and irsz='" + txt_irsz.Text + "';";
                ...
                else
                {
                    ...
                    if (reader.HasRows)
                    {
                        ...
                        adat.CommandText = "insert into konyvtarak (konyvtarNev,irsz,cim) values ('" + txt_nev.Text + "','" + txt_irsz.Text + "','" + txt_cim.Text + "');";
